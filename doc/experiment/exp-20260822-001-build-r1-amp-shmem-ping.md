...
本步骤记录主仓库本地 commit、内核本地 commit/patch、证据附件和只读冻结结果；主仓库尚未 push，内核 commit 尚未远程保存，不表示已经完成远程同步。
...
| R6 里程碑冻结与长期证据附件 | 保存本地源码身份、五份脱敏报告及其来源/校验关系，不提交大型产物 | 主仓库本地 commit `cdeb93dc3361fd30047cef9d88cd6e35297fd4d1`，内核仓库本地 commit `dcb7dfd7b`；冻结目录 `build/local/releases/mailmsg-v1-r6-20260831/` 约 77M，`final freeze-manifest.md`/`SHA256SUMS` 已生成，18 个 artifact/report/patch 的 `sha256sum -c` 全部通过并已只读；五份报告已复制至 `doc/_assets/mailmsg-r6/`，步骤 56 提供来源、附件链接和完整 SHA-256 | 通过（本机冻结完成；主仓库尚未 push，内核 commit 尚未远程保存，不提交大型产物） |
