...
对系统镜像、内核分支、构建系统、调试接口或 AI 工具链等会影响后续工作的选择，使用 [`templates/decision.md`](../templates/decision.md) 建档。文件名形如 `dec-20260805-001-select-base-image.md`。

记录约束、候选方案、取舍依据、最终选择和重新评估条件。被后续决策替代时标记为 `archived`，保留历史链接，不删除原理由来。
